...
class RaceResultStats:
	def on_get(self, req, resp):
		...
		if 'jvdHorseId' in req.params and 'courseId' in req.params and 'trackType' in req.params:
			#レスポンスの作成
			...
			sql_result = (
				...
				'left join ( '
				    ...
				    'and race_result.jvd_accident_master_id in (1,5,6,7,8) '
			...
			cur.execute(sql_result, (jvdHorseId, courseId, target_track_type_master_id[0], target_track_type_master_id[1]))
